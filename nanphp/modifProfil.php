...
<?php if(empty($prenom))echo $_SESSION['prenom']; else echo $prenom; ?>" />
                   ...
                   <div class="form-group col-md-6">
                       <a  href="dashbord.php" class="btn btn-secondary text-light offset-lg-2 col-lg-6 offset-md-2 col-md-6  col-12">ANNULER</a>
                   </div>
                   <div class="form-group col-md-6">
           ...
           <div>
            <form action="image.php" method="post" enctype="multipart/form-data" class="bg-success rounded" style="padding: 18px;  font-weight: bold">
                    <div class="form-group row">
                        ...
                        <a  href="dashbord.php" class="btn btn-secondary text-light col-lg-2  col-md-2 col-5 mr-1">ANNULER</a>
